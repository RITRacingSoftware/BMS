...
int32_T AccumulatorModel_afee0aca_1_ds_f(const NeDynamicSystem *t0, const
  NeDynamicSystemInput *t659, NeDsMethodOutput *t660)
{
  PmRealVector out;
  ...
  nonscalar9[1] = 293.15;
  nonscalar9[2] = 313.15;
  t363 = ((-X[90UL] + -X[91UL]) + X[92UL] * -0.05) + -U_idx_0;
  t33 = X[92UL] * 0.05;
  ...
  t71[0UL] = -0.0;
  t71[1UL] = -0.0;
  t71[2UL] = -t363 * (real_T)(t363 < 0.0) / (X[106UL] == 0.0 ? 1.0E-16 : X[106UL]);
  ...
  t71[90UL] = -(t363 * X[104UL]);
  t71[91UL] = -(((t363 * t363 * X[104UL] * 0.001 + X[4UL] * X[4UL] * X[101UL] *
