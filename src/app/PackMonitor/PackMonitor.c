...
void PackMonitor_validate_battery_model_10Hz(BatteryModel_t* bm)
{
    ...
    can_bus.bms_cell_overview.bms_overview_volt_min = main_dbc_bms_cell_overview_bms_overview_volt_min_encode((double) bm->smallest_V);
    can_bus.bms_cell_overview.bms_overview_volt_max = main_dbc_bms_cell_overview_bms_overview_volt_max_encode((double) bm->largest_V);
    can_bus.bms_cell_overview.bms_overview_volt_avg = main_dbc_bms_cell_overview_bms_overview_volt_avg_encode((double) bm->average_V);
    ...
    can_bus.bms_cell_overview.bms_overview_drains = main_dbc_bms_cell_overview_bms_overview_drains_encode(num_draining);
...
{
    can_bus.bms_cell_overview.bms_overview_temp_min = main_dbc_bms_cell_overview_bms_overview_temp_min_encode((double) tm->min_temp_C);
    can_bus.bms_cell_overview.bms_overview_temp_max = main_dbc_bms_cell_overview_bms_overview_temp_max_encode((double) tm->max_temp_C);
    can_bus.bms_cell_overview.bms_overview_temp_avg = main_dbc_bms_cell_overview_bms_overview_temp_avg_encode((double) tm->average_temp_C);
