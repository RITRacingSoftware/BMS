...
double LimpMode_temperature_limit(TempModel_t *tm)
{
    ...
    {
		#ifdef LIMP_MODE_ENABLE_TEMP_LEVEL_1
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_TEMP_LEVEL_2
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_TEMP_LEVEL_3
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_TEMP_LEVEL_4
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_TEMP_LEVEL_5
...
void Voltage_Limp_State_Machine(float min_voltage)
{
    switch(voltage_limp_state)
    {
		#ifdef LIMP_MODE_ENABLE_VOLTAGE_LEVEL_1
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_VOLTAGE_LEVEL_2
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_VOLTAGE_LEVEL_3
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_VOLTAGE_LEVEL_4
		...
		#endif
		#ifdef LIMP_MODE_ENABLE_VOLTAGE_LEVEL_5
