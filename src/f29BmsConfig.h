...
#define LOW_CURRENT_SENSOR_ADC_CHANNEL ADC_CHSELR_CHSEL0
#define ADC_MAX_VALUE 4095.0
#define Vref 3.3
#define ZERO_AMP_ADC_CAL 2054.0
#define ZERO_AMP_ADC_CAL_LOW 1
#define ZERO_AMP_REF_V ((ZERO_AMP_ADC_CAL/ADC_MAX_VALUE) * Vref)
#define ZERO_AMP_REF_V_LOW ((ZERO_AMP_ADC_CAL_LOW/ADC_MAX_VALUE) * Vref)
#define V_PER_A 0.0036168
#define V_PER_A_LOW 0.0235092
